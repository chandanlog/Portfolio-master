        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <i>
                <b className="purple"> Core Java HTML CSS Javascript and React.js </b>
              </i>
              <br />
              <br />
              ...
              <br />
              <br />
              Whenever possible, I also apply my passion Developing functionality and UI of website using
